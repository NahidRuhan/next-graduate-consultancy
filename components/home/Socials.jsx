    ...
    return (
        <div>
            ...
            <div className="flex flex-col lg:flex-row justify-center gap-5 xl:gap-10">
                ...
                <h1 className="text-white pb-5 font-bold text-xl">Address:</h1>
