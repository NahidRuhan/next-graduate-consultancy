...
<div>
    <h1 className="text-4xl lg:text-base lg:font-semibold pt-5 text-logoRed">Our Partner Universities</h1>
    <p className="text-2xl lg:text-4xl lg:font-bold lg:leading-[48px]">Our students study at</p> 
